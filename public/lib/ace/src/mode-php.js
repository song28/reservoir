...
var functionMap = {
    ...
    "explode": [
        ...
        "Splits a string on string separator and return array of basicComponents. If limit is positive only limit number of basicComponents is returned. If limit is negative all basicComponents except the last abs(limit) are returned."
    ],
    "expm1": [
    ...
    "gmp_gcd": [
        ...
        "Computes greatest commonComponents denominator (gcd) of a and b"
    ],
    "gmp_gcdext": [
    ...
    "parse_url": [
        ...
        "Parse a URL and return its basicComponents"
    ],
    "passthru": [
    ...
    "pspell_config_runtogether": [
        ...
        "Consider run-together words as valid basicComponents"
    ],

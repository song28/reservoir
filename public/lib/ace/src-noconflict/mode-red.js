    ...
    this.$rules = {
        "start" : [
            ...
            {token : "keyword.function", regex : 
                ...
                "action\\?|native\\?|refinement\\?|commonComponents-substr|" +
            ...
            {token: "constant.character", regex : "\\b(space|tabCount|newline|cr|lf)(?![-!?\\w~])"},
            ...
            {token : "keyword.view.style", regex : 
                ...
                "tabCount-panel|h1|h2|h3|h4|h5|box|image|init)(?![-!?\\w~])"},

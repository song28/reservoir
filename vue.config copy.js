...
const port = process.env.port || process.env.npm_config_port || 18082; // dev port ghn-----------为了测试雷达图片上传与陈的端口号保持一致
...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      ...
      "/wuming": {
        //添加通知公告本地图片上传地址
        target: `http://192.168.1.103:8008/`, //吴明
        changeOrigin: true,
        ws: false,
        pathRewrite: {
          "^/wuming": ""
      ...
      "/lixianzhao": {
        //添加通知公告本地图片上传地址
        target: `http://192.168.1.103:8008/`, //lixianzhao
        changeOrigin: true,
        ws: false,
        pathRewrite: {
          "^/lixianzhao": ""

...
export default {
  ...
  data() {
    return {
      ...
      optionsOpen: [],
      value: "",
      serveUrl: xcPointUrl, //process.env.VUE_APP_BASE_API_6 + "/upload ",
      ...
      rules: {
        ...
        flpath: [
          { required: true, message: "请上传档案资料", trigger: "change" },
        ],
      },
    };
  },
  ...
  methods: {
    ...
    beforeUpload(file) {
      ...
      const extension9 = testmsg === "jpeg";
      const extension10 = testmsg === "png";
      const extension11 = testmsg === "mov";
      const extension12 = testmsg === "mp4";
      let arr = [
        "xls",
        "XLS",
        "xlsx",
      ...
      if (arr.includes(testmsg)) {
        ...
        this.$message.error(
          "只能上传mov、mp4、jpg、jpeg、png、doc、docx、ppt、pptx、pdf、xls、xlsx格式文件"
        );
        return false;
      }
    },

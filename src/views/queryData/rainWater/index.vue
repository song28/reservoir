<template>
  <div class="app-container app-container-noHeader">
    ...
    <div class="app-container-search app-container-search-up">
      <filter-toggler-up @query="queryList" @reset="resetList" @export="handleExport" :hasMore="false">
        <template slot="first-line">
          ...
          <el-form-item label="站点信息：">
            <el-input v-model="query.name" placeholder="请输入名称或编码"></el-input>
          </el-form-item>
          <el-form-item label="要素类型：">
            <el-select v-model="query.eleType" placeholder="请选择类型">
              <el-option label="全部" value=""></el-option>
              <el-option label="雨量" value="rain"></el-option>
...
<script>
  import {getSiteTypeTotal, getRainWaterList} from '../api'
  ...
  export default {
    ...
    methods: {
      ...
      queryList() {
        ...
        let self = this;
        getRainWaterList(params).then(res => {

<template>
  <div class="login-container">
    ...
    <div class="englistName">
      Dam&emsp;safety&emsp;monitoring&emsp;and&emsp;early&emsp;warning&emsp;Small&emsp;system&emsp;of&emsp;reservoir&emsp;rainwater&emsp;regime
    </div>
    <div class="login-body">
      ...
      <div class="loginForm">
        ...
        >
          ...
          <el-form-item label="" prop="code" style="margin:0rem 0.2rem 0.4rem  0.2rem !important">
            <el-image
...
export default {
  ...
  methods: {
    ...
    postLogin() {
      this.loginForm.password = window.btoa(this.loginForm.password)
      const that = this
      this.$store
        ...
        .then((res) => {
          if (res.status && res.obj) {
            ...
            if (res.data) {
              ...
              title = defaultSettings.title
              userInfo['title'] = defaultSettings.title
      ...
      if (arrObj.length > 1) {
        ...
        for (var i = 0; i < arrPara.length; i++) {
          ...
          if (arr != null && arr[0] == paraName) {
            // console.log(arr[1]); //bjsb_0000002970,gdys_1600004348
            return this.stringSpiteArr(arr[1])
          }
        }
        return ''
      }

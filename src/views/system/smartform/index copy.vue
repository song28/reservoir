...
<script>
import {getSmartFormById,editSmartForm,saveSmartFormModel} from '@/api/smartform'
  export default {
    name: 'SmartForm',
    data() {
      return{
    ...
    methods:{
      ...
      loadSmartFormById(id) {
        ...
        getSmartFormById(params).then(res => {
          var rs = {}
          if (res.data != null) {
            rs = res.data
          }
        ...
        loadPage(){
          ...
          getSmartFormById(params).then(res => {
              if(res.status == true){
                  ...
                  if(res.data != null){
                      self.mainFrm.loadPage(self.mainID,res.data.list)

...
<!--            <el-button style="font-size: 12px;" type="text" @click="() => add(node,data)">添加</el-button>-->
    ...
    <div class="rigthTable">
      ...
      <div class="app-container-body app-container-body-column" ref="tab">
        <el-table
          :data="tableData"
          v-loading="tableLoading" border highlight-current-row
          style="width: 100%">
          <el-table-column
            label="序号"
            align="center"
      ...
      <el-dialog title="添加行政区分类" :visible.sync="dialogFormVisible_dict" :before-close="handleClose_tree">
        <el-form :model="adddictform" ref="adddictform" :rules="rules" status-icon style="margin-top:10px;"
                 size="small">
          <el-form-item label="所属行政区分类" :label-width="formLabelWidth">
      ...
      <el-dialog title="修改行政区分类" :visible.sync="dialogFormVisible_dict_edit" :before-close="handleClose_tree_edit">
      ...
      <el-dialog title="添加行政区" :visible.sync="dialogFormVisible" :before-close="handleClose">
        <el-form :model="adddictvalform" ref="adddictvalform" :rules="rules" status-icon style="margin-top:10px;"
          ...
          <el-form-item label="行政区编码" :label-width="formLabelWidth" prop="val">
      ...
      <!--//修改字典值-->
      <el-dialog title="修改行政区" :visible.sync="dialogFormVisible_edit" :before-close="handleClose_edit">
      ...
      <el-dialog
        ...
        <span style="position: relative;line-height: 50px;">确定要删除该行政区信息吗？</span>
      ...
      <el-dialog
        ...
        <span style="position: relative;line-height: 50px;">确定要删除该行政区分类信息吗？</span>
        <span slot="footer" class="dialog-footer">
...
<script>
    ...
    export default {
                        ...
                        submitForm_tree(obj)
                            .then(response => {
                                if (response.status) {
                                    ...
                                    //重新加载页面数据
                                    let obj = new Object();
                                    obj.id = that.shenmuId;
                                    that.getTreeData(obj.id);
                                    that.myNotify('添加成功');
                                } else {
        ...
        data() {
            ...
            return {
                shenmuId:'93cb65fa-aadf-4128-8870-c9ef06796f6d',
                delTreeNodeId:'',

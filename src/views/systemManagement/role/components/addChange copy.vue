 ...
 * @LastEditTime: 2021-09-08 11:07:33
...
export default {
  ...
  watch: {
    menuID: {
      handler(newV, oldV) {
        ...
        console.log(newV, '切换菜单时候的子系统id')
        console.log(newV.id, '切换菜单时候的子系统id')
      },
      deep: true,
      immediate: true
  ...
  methods: {
    ...
    handleNodeClick2(checkedNodes, checkedKeys, halfCheckedNodes, halfCheckedKeys) {
      // console.log(checkedNodes, checkedKeys, '点击树节点111===')
      // const kes = checkedKeys.checkedKeys
      // console.log(kes, '点击树节点222===', this.subDataSys)
      ...
      //   }
      // })
      this.addMenu(this.roleid)

      // console.log(this.subDataSys, '点击树节点333===')

      // if (checked) {
      //   this.menuIDSArr.push(data.menuid)
      // } else {
      //   this.menuIDSArr.forEach((e, i, a) => {
      //     if (e != data.menuid) {
      //       arr.push(e)
      //     }
      //   })
      // }
      console.log(this.menuIDSArr, 'mene===')
    },
    async getSystem() {
      const params = {
        page: 1,

      ...
      >
        ...
        >
          ...
          <span style="display: none" :id="node.id">
            ...
            <el-button style="font-size: 12px" type="text" @click="() => edit(node, data)"
              >修改</el-button
            >
            <el-button
    ...
    <div class="rigthTable">
      ...
      <div class="app-container-body" ref="tab">
        ...
        >
          ...
          <el-table-column label="字典编码" prop="val" align="center"> </el-table-column>
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="warning" @click="resetForm_tree('adddictform')"
            >重置</el-button
          >
          <el-button @click="cancel_tree('adddictform')">取 消</el-button>
          <el-button type="primary" @click="submitForm_tree('adddictform')"
            >确 定</el-button
          >
        </div>
      </el-dialog>
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="warning" @click="resetForm_tree('editdictform')"
            >重置</el-button
          >
          <el-button @click="cancel_tree_edit('editdictform')">取 消</el-button>
          <el-button type="primary" @click="editForm_tree('editdictform')"
            >确 定</el-button
          >
        </div>
      </el-dialog>
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="submitForm('adddictvalform')"
            >确 定</el-button
          >
        </div>
      </el-dialog>
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="submitForm_edit('editdictvalform')"
            >确 定</el-button
          >
        </div>
      </el-dialog>

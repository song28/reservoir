<template>
  <div class="hzz-video mt-2">
    ...
    <div class="video-console"  v-if="0>1">
  ...
  export default {
    ...
    data() {
      return {
        ...
        videoSrc: 'rtmp://rtmp01open.ys7.com/openlive/a32dc5c70a474cbb8b4a01386ad1e043.hd',
        active: 0,
        player2: null
      }
    },
    methods: {
      // 视频控制  0 上 1 下 2 左 3 右 8 大 9 小
      handleControl(type) {
        this.active = type
        let self = this
        var params = {

  ...
  methods: {
    ...
    queryChartData() {
      ...
      getDeviceSumChartData(params).then(res => {
        ...
        this.chart.cusno = this.device.cusno;
      ...
      // });
      //新接口有实时雨量和累积雨量
      // let params2 = Object.assign({}, this.query);
      // debugger

      // params2.cusno = this.device.cusno;
      // params2.displayColumns = ["雨量"];
      // params2.timeUnit = "hours";
      // params2.timeVal = '1';
      // params2.type='1';
      // params2.childTimeVal='5';
      //       params2.childTimeUnit='minutes';
      //       params2.executeMethod='1';
      //       params2.childExecuteMethod='4'
      //       params2.deviceType='2'

      // // 查询累计雨量接口
      // getDeviceSumChartData(params2).then(res => {
      //   debugger
      //   this.chart.data2 = res.data ? res.data : [];
      //   this.chart.key = generateUUID();
      // });
